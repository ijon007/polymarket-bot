"""SQLAlchemy models for markets, trades, positions, and opportunities."""
...
class Trade(Base):
    ...
    id = Column(Integer, primary_key=True, autoincrement=True)
    market_ticker = Column(String(255), nullable=False)
...
class Opportunity(Base):
    """Detected opportunity: logic, arb, or combo."""

    __tablename__ = "opportunities"

    id = Column(Integer, primary_key=True, autoincrement=True)
    market_ticker = Column(String(255), nullable=False)
    type = Column(String(32), nullable=False)  # logic, arb, combo
